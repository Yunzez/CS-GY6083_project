...
ALTER TABLE AFZ_Activity
    ...
    CHECK ( Source_Type IN ('AFZ_Activity', 'Par', 'Tic') )
GO
...
ALTER TABLE AFZ_Facility
    ...
    CHECK ( Source_Type IN ('Att', 'Par', 'Shw', 'Sto') )
GO
...
CREATE TABLE AFZ_Item_Store
    (
     IS_ID NUMERIC (28) NOT NULL IDENTITY NOT FOR REPLICATION ,
...
CREATE TABLE AFZ_Parking
    (
     Activity_ID NUMERIC (10) NOT NULL ,
     Parking_Lot_Facility_ID NUMERIC (5) NOT NULL ,
...
EXEC sp_addextendedproperty 'MS_Description' , 'The Facility UID of the Parking Lot
' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Parking' , 'COLUMN' , 'Parking_Lot_Facility_ID'
GO
...
CREATE TABLE AFZ_Parking_Locations
    (
     ...
     Parking_Lot_Section VARCHAR (1) NOT NULL
    )
GO



EXEC sp_addextendedproperty 'MS_Description' , 'Unique location section id.' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Parking_Locations' , 'COLUMN' , 'Parking_Section_ID'
GO



EXEC sp_addextendedproperty 'MS_Description' , 'Location Section UID' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Parking_Locations' , 'COLUMN' , 'Parking_Lot_Section'
GO

ALTER TABLE AFZ_Parking_Locations ADD CONSTRAINT AFZ_Parking_Locations_PK PRIMARY KEY CLUSTERED (Parking_Section_ID)
     WITH (
     ALLOW_PAGE_LOCKS = ON ,
     ALLOW_ROW_LOCKS = ON )
GO

CREATE TABLE AFZ_Parking_Lot
    (
     Facility_ID NUMERIC (5) NOT NULL ,
...
EXEC sp_addextendedproperty 'MS_Description' , 'The UID of the facility. The primary key' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Parking_Lot' , 'COLUMN' , 'Facility_ID'
GO



EXEC sp_addextendedproperty 'MS_Description' , 'The Spot Number of the parking lot.' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Parking_Lot' , 'COLUMN' , 'Spot_Number'
GO



EXEC sp_addextendedproperty 'MS_Description' , 'Section of this spot.' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Parking_Lot' , 'COLUMN' , 'Parking_Section_ID'
GO

ALTER TABLE AFZ_Parking_Lot ADD CONSTRAINT AFZ_Parking_Lot_PK PRIMARY KEY CLUSTERED (Facility_ID)
     WITH (
     ALLOW_PAGE_LOCKS = ON ,
     ALLOW_ROW_LOCKS = ON )
GO
...
ALTER TABLE AFZ_Parking_Lot
    ADD CONSTRAINT Parking_Lot_Facility_FK FOREIGN KEY
    (
     Facility_ID
    )
    REFERENCES AFZ_Facility
...
ALTER TABLE AFZ_Parking_Lot
    ADD CONSTRAINT Parking_Lot_Locations_FK FOREIGN KEY
    (
     Parking_Section_ID
    )
...
ALTER TABLE AFZ_Parking
    ADD CONSTRAINT PParking_Lot_FK FOREIGN KEY
    (
     Parking_Lot_Facility_ID
    )
    REFERENCES AFZ_Parking_Lot
    (
     Facility_ID
    )
    ON DELETE NO ACTION
...
CREATE OR ALTER TRIGGER validate_ticket_trigger
ON AFZ_Tickets
FOR SELECT
AS
BEGIN
    UPDATE AFZ_Tickets
    SET validate = CASE
        WHEN visit_date < DATEADD(day, -1, GETDATE()) THEN 0
        ELSE 1
    END;
END;
