...
EXEC sp_addextendedproperty 'MS_Description' , 'The status of the attraction' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Attractions' , 'COLUMN' , 'Attraction_Status_ID' 
GO



EXEC sp_addextendedproperty 'MS_Description' , 'The location of the attraction' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Attractions' , 'COLUMN' , 'Attraction_Locations_ID' 
GO
...
CREATE TABLE AFZ_Facility 
    (
     Facility_ID NUMERIC (5) IDENTITY (1,1) NOT NULL ,
...
EXEC sp_addextendedproperty 'MS_Description' , 'The Type of the Facility.' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Facility' , 'COLUMN' , 'Facility_Type' 
GO
...
CREATE TABLE AFZ_Item_Store 
    (
     IS_ID NUMERIC (5) IDENTITY (1,1) NOT NULL ,
...
EXEC sp_addextendedproperty 'MS_Description' , 'Primary key of this table.' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Item_Store' , 'COLUMN' , 'IS_ID' 
GO
...
EXEC sp_addextendedproperty 'MS_Description' , 'The facility UID of the store' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Item_Store' , 'COLUMN' , 'Store_Facility_ID' 
GO
...
ALTER TABLE AFZ_Item_Store ADD CONSTRAINT AFZ_Item_Store_PK PRIMARY KEY CLUSTERED (IS_ID)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
CREATE TABLE AFZ_Order 
    (
     Order_ID NUMERIC (5) IDENTITY (1,1) NOT NULL ,
     IS_ID NUMERIC (5) NOT NULL , 
     PS_ID NUMERIC (10) NOT NULL , 
...
EXEC sp_addextendedproperty 'MS_Description' , 'The ID of IS.' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Order' , 'COLUMN' , 'IS_ID' 
GO



EXEC sp_addextendedproperty 'MS_Description' , 'The payment source ID' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Order' , 'COLUMN' , 'PS_ID' 
GO
...
CREATE TABLE AFZ_Parking 
    (
     ...
     Parking_Locations_ID NUMERIC (2) NOT NULL 
    )
GO 



EXEC sp_addextendedproperty 'MS_Description' , 'The UID of the facility. The primary key' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Parking' , 'COLUMN' , 'Facility_ID' 
GO
...
EXEC sp_addextendedproperty 'MS_Description' , 'The ID of the Parking secion
' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Parking' , 'COLUMN' , 'Parking_Locations_ID' 
GO

ALTER TABLE AFZ_Parking ADD CONSTRAINT AFZ_Parking_PK PRIMARY KEY CLUSTERED (Facility_ID)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
EXEC sp_addextendedproperty 'MS_Description' , 'The UID of the source of the payment' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Parking_Pay' , 'COLUMN' , 'PS_ID' 
GO



EXEC sp_addextendedproperty 'MS_Description' , 'The time the visitor starts parking' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Parking_Pay' , 'COLUMN' , 'Time_In' 
GO



EXEC sp_addextendedproperty 'MS_Description' , 'The time the visitor ends  parking' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Parking_Pay' , 'COLUMN' , 'Time_Out' 
GO

ALTER TABLE AFZ_Parking_Pay ADD CONSTRAINT AFZ_Parking_Pay_PK PRIMARY KEY CLUSTERED (PS_ID)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
CREATE TABLE AFZ_Payment 
    (
     Payment_ID NUMERIC (10) IDENTITY (1,1) NOT NULL ,
...
EXEC sp_addextendedproperty 'MS_Description' , 'The UID of the payment Resource.' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Payment' , 'COLUMN' , 'PS_ID' 
GO



EXEC sp_addextendedproperty 'MS_Description' , 'The Facility UID of the payment source. This is optional because ticket does not have corrsponding facility.
' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Payment' , 'COLUMN' , 'Facility_ID' 
GO
...
CREATE TABLE AFZ_Payment_Source 
    (
     PS_ID NUMERIC (10) IDENTITY (1,1) NOT NULL ,
...
EXEC sp_addextendedproperty 'MS_Description' , 'The UID of the source of the payment' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Payment_Source' , 'COLUMN' , 'PS_ID' 
GO



EXEC sp_addextendedproperty 'MS_Description' , 'The total amount due to the source.' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Payment_Source' , 'COLUMN' , 'Amount_Due' 
GO



EXEC sp_addextendedproperty 'MS_Description' , 'The ID of the payment source facility
' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Payment_Source' , 'COLUMN' , 'Facility_ID' 
GO



EXEC sp_addextendedproperty 'MS_Description' , 'The type of the facility of the payment source.
' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Payment_Source' , 'COLUMN' , 'Source_Type' 
GO

ALTER TABLE AFZ_Payment_Source ADD CONSTRAINT AFZ_Payment_Source_PK PRIMARY KEY CLUSTERED (PS_ID)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
ALTER TABLE AFZ_Source_Type ADD CONSTRAINT Source_Type_PK PRIMARY KEY CLUSTERED (Source_Type)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
CREATE TABLE AFZ_Tickets 
    (
     PS_ID NUMERIC (10) NOT NULL , 
     Method_Method_ID NUMERIC (1) NOT NULL , 
...
EXEC sp_addextendedproperty 'MS_Description' , 'The UID of the source of the payment' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Tickets' , 'COLUMN' , 'PS_ID' 
GO



EXEC sp_addextendedproperty 'MS_Description' , 'The UID of the ticket purchase  method' , 'USER' , 'dbo' , 'TABLE' , 'AFZ_Tickets' , 'COLUMN' , 'Method_Method_ID' 
GO
...
ALTER TABLE AFZ_Tickets ADD CONSTRAINT AFZ_Tickets_PK PRIMARY KEY CLUSTERED (PS_ID)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
EXEC sp_addextendedproperty 'MS_Description' , 'The type of visitor
...
ALTER TABLE AFZ_Facility 
    ADD CONSTRAINT Facility_Type_FK FOREIGN KEY 
    ( 
     Facility_Type
    ) 
...
ALTER TABLE AFZ_Item_Store 
    ADD CONSTRAINT IS_Item_FK FOREIGN KEY 
    ( 
     Item_ID
    ) 
    REFERENCES AFZ_Item 
...
ALTER TABLE AFZ_Item_Store 
    ADD CONSTRAINT IS_Store_FK FOREIGN KEY 
    ( 
     Store_Facility_ID
    ) 
...
ALTER TABLE AFZ_Order 
    ADD CONSTRAINT Order_IS_FK FOREIGN KEY 
    ( 
     IS_ID
    ) 
...
ALTER TABLE AFZ_Order 
    ADD CONSTRAINT Order_Payment_Source_FK FOREIGN KEY 
    ( 
     PS_ID
    ) 
    REFERENCES AFZ_Payment_Source 
    ( 
     PS_ID 
    ) 
    ON DELETE NO ACTION 
...
ALTER TABLE AFZ_Parking 
    ADD CONSTRAINT Parking_Facility_FK FOREIGN KEY 
    ( 
     Facility_ID
    ) 
    REFERENCES AFZ_Facility 
...
ALTER TABLE AFZ_Payment 
    ADD CONSTRAINT Payment_Source_FK FOREIGN KEY 
    ( 
     PS_ID
    ) 
    REFERENCES AFZ_Payment_Source 
...
ALTER TABLE AFZ_Parking_Pay 
    ADD CONSTRAINT PP_PS_FK FOREIGN KEY 
    ( 
     PS_ID
    ) 
    REFERENCES AFZ_Payment_Source 
...
ALTER TABLE AFZ_Payment_Source 
    ADD CONSTRAINT PS_Facility_FK FOREIGN KEY 
    ( 
     Facility_ID
    ) 
    REFERENCES AFZ_Facility 
...
ALTER TABLE AFZ_Payment_Source 
    ADD CONSTRAINT PS_Source_Type_FK FOREIGN KEY 
    ( 
     Source_Type
    ) 
    REFERENCES AFZ_Source_Type 
...
ALTER TABLE AFZ_Tickets 
    ADD CONSTRAINT Tickets_PS_FK FOREIGN KEY 
    ( 
     PS_ID
    ) 
    REFERENCES AFZ_Payment_Source 
...
ALTER TABLE AFZ_Facility
    ...
    CHECK ( Facility_Type IN ('Att', 'Par', 'Shw', 'Sto'))
GO

ALTER TABLE AFZ_Payment_Source
    ADD CONSTRAINT CH_INH_AFZ_Payment_Source
    CHECK ( Source_Type IN ('Att', 'Par', 'Shw', 'Sto', 'Tic'))
GO
