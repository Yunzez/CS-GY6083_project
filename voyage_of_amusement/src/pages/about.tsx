    ...
    <div className="bg-gray-100 h-screen py-[10%] overflow-hidden">
      <div className="max-w-4xl mx-auto ">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            className="bg-white rounded-lg shadow-lg p-1 overflow-y-scroll"
          ...
          >
            {isAmusementParkVisible && (
              <div className="px-4 py-6 md:p-12 text-center ">
                <h1 className="md:text-4xl  text-lg font-bold mb-4">Voyage of Amusement</h1>
          ...
          >
            {!isAmusementParkVisible && (
              <div className="px-4 py-6 md:p-12 text-center">
                <h1 className="md:text-4xl text-lg  font-bold mb-4">About the Project</h1>
                <p className="md:text-lg mb-4">
