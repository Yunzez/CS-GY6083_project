...
export default function Home() {
  ...
  return (
    <div className="flex flex-col  mb-5  bottom-0 pb-16">
      <div className="relative h-80 sm:h-96 mb-5">
        <Image
      ...
      <div className="bg-gray-100 py-10">
        ...
        <div className="flex flex-col md:flex-row justify-around max-w-7xl mx-auto">
          ...
          <div className="w-full md:w-1/3 bg-white rounded-lg shadow-md p-8 mb-8 md:mb-0 m-4 ">
            ...
            <button className="px-4 py-2 bg-yellow-500 text-white rounded-full hover:bg-yellow-600 transition-colors duration-300">Learn More</button>
          </div>
